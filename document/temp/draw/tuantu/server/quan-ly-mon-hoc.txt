...
Admin -> UI: Chọn chức năng Quản lý môn học

alt Thêm môn học mới
    Admin -> UI: Nhập thông tin môn học
    UI -> System: Gửi thông tin môn học
    System -> DB: Kiểm tra thông tin môn học
    DB --> System: Kết quả kiểm tra
    alt Thông tin hợp lệ
        System -> DB: Lưu thông tin môn học vào cơ sở dữ liệu
...
alt Chỉnh sửa môn học
    Admin -> UI: Chọn môn học cần chỉnh sửa
    UI -> System: Gửi thông tin cập nhật
    System -> DB: Cập nhật thông tin môn học
    DB --> System: Xác nhận cập nhật thành công
    System -> UI: Thông báo thành công
end

alt Xóa môn học
    Admin -> UI: Chọn môn học cần xóa
    UI -> System: Gửi yêu cầu xóa
    System -> DB: Xác nhận xóa môn học
    DB --> System: Xác nhận xóa thành công
    System -> UI: Cập nhật danh sách môn học
end

alt Nhập danh sách môn học từ Excel
...
alt Xuất danh sách môn học ra Excel
    System -> UI: Tạo tệp Excel danh sách môn học
