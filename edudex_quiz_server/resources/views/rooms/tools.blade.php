...
@section('title', 'Công cụ Import/Export Phòng thi')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 border-end">
                            ...
                            <form action="{{ route('rooms.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('rooms.template') }}" class="btn btn-outline-primary me-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Tải xuống danh sách phòng thi dưới dạng file Excel.</p>
                            <div class="mb-3">
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0 ps-3">
                                    <li>Bao gồm tất cả phòng thi</li>
                                    <li>Kèm thông tin cơ sở</li>
