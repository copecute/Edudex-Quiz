            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('exams.store') }}" method="POST" id="examForm">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h6 class="mb-0">Tỷ lệ độ khó chung (tự động tính từ tags)</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="form-label">Tỷ lệ độ khó dễ (%)</label>
                                        <input type="number" class="form-control difficulty-rate" name="easy_rate" 
                                               value="{{ old('easy_rate', 40) }}" min="0" max="100" required>
                                        <small class="text-muted easy-questions"></small>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Tỷ lệ độ khó trung bình (%)</label>
                                        <input type="number" class="form-control difficulty-rate" name="medium_rate" 
                                               value="{{ old('medium_rate', 40) }}" min="0" max="100" required>
                                        <small class="text-muted medium-questions"></small>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Tỷ lệ độ khó khó (%)</label>
                                        <input type="number" class="form-control difficulty-rate" name="hard_rate" 
                                               value="{{ old('hard_rate', 20) }}" min="0" max="100" required>
                        ...
                        <div class="card mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-primary" id="addTagBtn" disabled>
...
$(document).ready(function() {
    ...
    function initializeTagSelect(element) {
        ...
        $(element).select2({
            ...
            // Thêm sự kiện khi select2 thay đổi
