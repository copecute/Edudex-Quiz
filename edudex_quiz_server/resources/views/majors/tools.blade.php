...
@section('title', 'Công cụ nhập/xuất ngành')
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('majors.index') }}">Quản lý ngành</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nhập dữ liệu ngành từ file Excel.</p>
                                    <form action="{{ route('majors.import') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <a href="{{ route('majors.template') }}" class="btn btn-success">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Xuất dữ liệu ngành ra file Excel.</p>
                                    <a href="{{ route('majors.export') }}" class="btn btn-success">
