...
@section('title', 'Công cụ nhập/xuất môn học')
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nhập dữ liệu môn học từ file Excel.</p>
                                    <form action="{{ route('subjects.import') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <a href="{{ route('subjects.template') }}" class="btn btn-success">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Xuất dữ liệu môn học ra file Excel.</p>
                                    <a href="{{ route('subjects.export') }}" class="btn btn-success">
