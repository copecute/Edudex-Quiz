...
@section('title', 'Công cụ Import/Export Tài khoản')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 border-end">
                            ...
                            <form action="{{ route('accounts.import') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('accounts.template') }}" class="btn btn-outline-primary me-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <a href="{{ route('accounts.export') }}" class="btn btn-success">
                            ...
                            <div class="alert alert-info">
                                ...
                                <ul class="mb-0 ps-3">
                                    <li>Bao gồm tất cả tài khoản</li>
