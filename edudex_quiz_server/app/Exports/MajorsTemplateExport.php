...
class MajorsTemplateExport implements FromArray, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A1:E4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                ...
                $event->sheet->getStyle('A5:D5')->getFont()->setBold(true);
                
                // Border cho bảng dữ liệu
                $event->sheet->getStyle('A5:D' . count($this->array()))->applyFromArray([
                    'borders' => [
                        'allBorders' => [
